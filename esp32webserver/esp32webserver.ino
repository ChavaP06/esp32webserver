      ...
      serializeJson(doc, jsonStr);
       ...
       if(client.connect("espClient")){
        ...
        Serial.println("broker connected");
          ...
          String machineTopic = "iot/" + hostname + "/mcdata";
...
//        Serial.print(Data.size());
    ...
    server.on("/setMQTTSettings", HTTP_GET, [](AsyncWebServerRequest * request){
      ...
      if(request->hasParam("mqttaddress") && request->hasParam("mqttport") && request->hasParam("mqttinterval") && request->hasParam("mqttenable") ){
      ...
      previousTime = currentTime;
       ...
       for(int i = 0; i < 41; i++){
        ...
        if(prev_mc_status_state != mc_status_state){//mc status process
          ...
          if(mc_status_state != "0000000000"){//mc status won't do anything if it's 0000000000
...
//               Serial.println(statusCount);
               ...
               if(formatTime(Data[40], Data[41], Data[42], Data[43], Data[44], Data[45]) != "0-00-00 00:00:00")
...
//  }
      ...
      if(dataFile){
        ...
        dataFile.close();
        ftp.InitFile("Type A");
        String filename_mcstatus = "gd_mc_status_"+hostname+".txt";
...
void sent_ftp_alarm_list(){
      ...
      if(dataFile){
        ...
        dataFile.close();
        ftp.InitFile("Type A");
        String filename_alarmlist = "gd_alarm_list_"+hostname+".txt";
